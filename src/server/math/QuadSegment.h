...
#ifndef SERVER_MATH_QUADSEGMENT_H_
#define SERVER_MATH_QUADSEGMENT_H_
...
template <int CoordDim>
QuadSegment<CoordDim> join(
    const QuadSegment<CoordDim>& left,
    const QuadSegment<CoordDim>& right,
...
#endif /* SERVER_MATH_QUADSEGMENT_H_ */
