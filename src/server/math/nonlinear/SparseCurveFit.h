...
struct Settings {
  // This is the settings of the underlying algorithm used to solve the problem.
  ...
  // have to tune a parameter because one size doesn't fit all. But in most cases, I believe that say,
  // around the best 60% of the samples should be high quality observations even for crappy gps devices.
