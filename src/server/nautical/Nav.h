...
public:
	...
	// For sorting
	bool operator< (const Nav &other) const {return _timeDays < other._timeDays;}

	double getTimeDays() const{return _timeDays;}
	double getTimeSeconds() const {return 24*60*60*_timeDays;}
