...
TEST(LinearOptCalib, SlackFitnessTest) {
  Eigen::MatrixXd K(9, 9);
  K(0, 0) = -0.333333333333333;
  K(0, 1) = -0.000000000000000;
  K(0, 2) = -0.000000000000000;
  K(0, 3) = 0.333333333333333;
  K(0, 4) = 0.000000000000000;
  K(0, 5) = 0.000000000000000;
  K(0, 6) = 0.333333333333334;
  K(0, 7) = 0.000000000000000;
  K(0, 8) = 0.000000000000000;
  K(1, 0) = -0.000000000000000;
  K(1, 1) = -0.333333333333333;
  K(1, 2) = -0.000000000000000;
  K(1, 3) = 0.000000000000000;
  K(1, 4) = 0.333333333333333;
  K(1, 5) = 0.000000000000000;
  K(1, 6) = 0.000000000000000;
  K(1, 7) = 0.333333333333334;
  K(1, 8) = 0.000000000000000;
  K(2, 0) = -0.000000000000000;
  K(2, 1) = -0.000000000000000;
  K(2, 2) = -0.333333333333333;
  K(2, 3) = 0.000000000000000;
  K(2, 4) = 0.000000000000000;
  K(2, 5) = 0.333333333333333;
  K(2, 6) = 0.000000000000000;
  K(2, 7) = 0.000000000000000;
  K(2, 8) = 0.333333333333334;
  K(3, 0) = 0.333333333333333;
  K(3, 1) = 0.000000000000000;
  K(3, 2) = 0.000000000000000;
  K(3, 3) = -0.333333333333334;
  K(3, 4) = -0.000000000000000;
  K(3, 5) = -0.000000000000000;
  K(3, 6) = -0.333333333333333;
  K(3, 7) = -0.000000000000000;
  K(3, 8) = -0.000000000000000;
  K(4, 0) = 0.000000000000000;
  K(4, 1) = 0.333333333333333;
  K(4, 2) = 0.000000000000000;
  K(4, 3) = -0.000000000000000;
  K(4, 4) = -0.333333333333334;
  K(4, 5) = -0.000000000000000;
  K(4, 6) = -0.000000000000000;
  K(4, 7) = -0.333333333333333;
  K(4, 8) = -0.000000000000000;
  K(5, 0) = 0.000000000000000;
  K(5, 1) = 0.000000000000000;
  K(5, 2) = 0.333333333333333;
  K(5, 3) = -0.000000000000000;
  K(5, 4) = -0.000000000000000;
  K(5, 5) = -0.333333333333334;
  K(5, 6) = -0.000000000000000;
  K(5, 7) = -0.000000000000000;
  K(5, 8) = -0.333333333333333;
  K(6, 0) = 0.333333333333333;
  K(6, 1) = 0.000000000000000;
  K(6, 2) = 0.000000000000000;
  K(6, 3) = -0.333333333333333;
  K(6, 4) = -0.000000000000000;
  K(6, 5) = -0.000000000000000;
  K(6, 6) = -0.333333333333333;
  K(6, 7) = -0.000000000000000;
  K(6, 8) = -0.000000000000000;
  K(7, 0) = 0.000000000000000;
  K(7, 1) = 0.333333333333333;
  K(7, 2) = 0.000000000000000;
  K(7, 3) = -0.000000000000000;
  K(7, 4) = -0.333333333333333;
  K(7, 5) = -0.000000000000000;
  K(7, 6) = -0.000000000000000;
  K(7, 7) = -0.333333333333333;
  K(7, 8) = -0.000000000000000;
  K(8, 0) = 0.000000000000000;
  K(8, 1) = 0.000000000000000;
  K(8, 2) = 0.333333333333333;
  K(8, 3) = -0.000000000000000;
  K(8, 4) = -0.000000000000000;
  K(8, 5) = -0.333333333333333;
  K(8, 6) = -0.000000000000000;
  K(8, 7) = -0.000000000000000;
  K(8, 8) = -0.333333333333333;
  auto x = makeSlackFitness(3).toDense();
  EXPECT_EQ(x.rows(), K.rows());
  EXPECT_EQ(x.cols(), K.cols());
  for (int i = 0; i < K.rows(); i++) {
    for (int j = 0; j < K.cols(); j++) {
      EXPECT_NEAR(K(i, j), x(i, j), 1.0e-6);
    }
  }
}
