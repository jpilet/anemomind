...
class ParsedNavs {
 public:
  ...
  ParsedNavs() {}
  ParsedNavs(NavDataset navs, FieldMask fields) : _navs(navs), _fields(fields) {}
  ParsedNavs(NavDataset navs) : _navs(navs), _fields(fieldsFromNavs(navs)) {}

  NavDataset navs() {return _navs;}
  ...
  static FieldMask fieldsFromNavs(const NavDataset &navs);
