...
#ifndef DEVICE_TARGET_SPEED_TEST_DATA_H
#define DEVICE_TARGET_SPEED_TEST_DATA_H
...
void fillTestSpeedTable(TargetSpeedTable *table) {
...
#endif // DEVICE_TARGET_SPEED_TEST_DATA_H
