...
var fullschema = "CREATE TABLE seqnumbers (dst TEXT, counter BIGINT, PRIMARY KEY(dst)); CREATE TABLE packets (diarynumber BIGINT, src TEXT, dst TEXT, seqnumber BIGINT, cnumber BIGINT, label TEXT, data BLOB, ack INTEGER, PRIMARY KEY(diarynumber)); CREATE TABLE diarynumbers (mailbox TEXT, number BIGINT, PRIMARY KEY(mailbox)); CREATE TABLE ctable (src TEXT, dst TEXT, counter BIGINT);";
