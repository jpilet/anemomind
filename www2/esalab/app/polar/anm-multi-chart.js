// This file is a for of
// https://github.com/novus/nvd3/blob/master/src/models/multiChart.js
//
// Changes: add support for xDomain
nv.models.anmMultiChart = function() {
    "use strict";
    ...
    function chart(selection) {
        selection.each(function(data) {
            ...
            if (!xDomain) {
              xDomain = d3.extent(d3.merge(series1.concat(series2),
                                           function(d) { return d.x }))
            }

            x   .domain(xDomain)
                .range([0, availableWidth]);
            //scatters1.x().domain(xDomain);
