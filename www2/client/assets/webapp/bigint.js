...
export function isBigIntStrict(x) {
...
export function withDefaultWidth(x) {
...
export function calcEvenLength(x) {
    assert.equal(typeof x, 'number');
    var even = (x % 2) == 0;
    return (even? x : x + 1);
}

export function calcByteCount(x) {
    return calcEvenLength(x)/2;
}

export function padToEvenDigits(x) {
    return padWith0(x, calcEvenLength(x.length));
}


export function serializeBigIntToBuffer(x, dstBuffer, dstOffset) {
...
export function serializeBigInt(x) {
...
export function deserializeBigIntFromBuffer(srcBuffer, srcOffset, dstWidth) {
...
export function deserializeBigInt(srcBuffer, dstWidth) {
...
export function deserializeBigInts(buf, width) {
