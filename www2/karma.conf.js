...
module.exports = function(config) {
  config.set({
    ...
    files: [
      ...
      'client/bower_components/sidebar-v2/css/leaflet-sidebar.js',
      ...
      'client/bower_components/sidebar-v2/js/leaflet-sidebar.js',
      'node_modules/socket.io-client/socket.io.js',
      'client/bower_components/leaflet-tilelayer-geojson/TileLayer.GeoJSON.js',
      'client/app/app.js',
