...
var withEps = dd.macro(function() {
  ...
  return ['let', [['boat', 'g0', 'g1', 'box'], args[0]]].concat(args.slice(1));
});
...
eval(dd.parse('(dafn test2 (eps) (let ((box g0 g1 boat) eps)))'));

eval(dd.parse('(dafn runTest () (let (eps (makeEndPoints)) (test1 eps) (test2 eps) (console.log "Done")))'));
